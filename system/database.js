module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '@SysSolutions'
      ...
      if (!('owners' in setting)) setting.owners = ['51945463812']
      if (!isNumber(setting.lastReset)) setting.lastReset = new Date * 1
      if (!('msg' in setting)) setting.msg = 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.neoxr.my.id\n◦ *Source* : https://github.com/SysSolutionsPE/neox\n\nIf you find an error or want to upgrade premium plan contact the owner.'
      if (!isNumber(setting.menuStyle)) setting.menuStyle = 4
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/7e93e63346657d87e7f30.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/FugA0hPt8Jm1fkm5LFrzAT'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: true,
         ...
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.neoxr.my.id\n◦ *Source* : https://github.com/SysSolutionsPE/neox\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         menuStyle: 4,
         cover: 'https://telegra.ph/file/7e93e63346657d87e7f30.jpg',
         link: 'https://chat.whatsapp.com/FugA0hPt8Jm1fkm5LFrzAT'
      }
   }
}
